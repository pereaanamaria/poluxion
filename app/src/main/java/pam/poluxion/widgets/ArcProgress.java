...
public class ArcProgress extends View {
    ...
    private final int default_finished_color = Color.rgb(142, 171, 140);
    private final int default_unfinished_color = Color.rgb(201, 227, 200);
    private final int default_text_color = Color.rgb(98, 117, 96);
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_suffix_text_size = Utils.sp2px(getResources(), 12);
        default_suffix_padding = Utils.dp2px(getResources(), 15);
        default_suffix_text = "%";
        default_bottom_text_size = Utils.sp2px(getResources(), 12);
